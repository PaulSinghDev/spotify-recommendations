      ...
      <header className="px-8 pt-24 flex flex-col items-center">
        <div className="max-w-[600px]">
          ...
          <div className="mt-6 flex gap-4 flex-col md:flex-row">
            ...
            {[...tracksForFeatures, ...artistsForFeatures, ...genresForFeatures]
              ...
              >
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      How many tracks do you want to include in your playlist?
                      You must select between 10 and 100 tracks
                    </DialogDescription>
                  </DialogHeader>
                  <div>
                  ...
                  {!playlistCreated && !playlistError ? (
                    <div>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Enter a playlist name below and this playlist will be
                          added to your spotify account
                        </DialogDescription>
                      </DialogHeader>
                      <AddPlaylistForm
                  ...
                  {playlistError ? (
                    <div>
                      ...
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          There was an error when making your playlist, check
                          that you have selected some seed tracks and try again.
                        </DialogDescription>
                      </DialogHeader>
                    </div>
                  ) : null}
          ...
          {genres.length ? (
            <div className="flex flex-col p-8">
              ...
              {genres.length ? (
                ...
                <div>
                  Select some genres to use for your recommendations below
                </div>
              )}
            </div>
          ) : null}
